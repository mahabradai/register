...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, tn.pediatric.register.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, tn.pediatric.register.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, tn.pediatric.register.domain.Patientform.class.getName());
            createCache(cm, tn.pediatric.register.domain.Departement.class.getName());
